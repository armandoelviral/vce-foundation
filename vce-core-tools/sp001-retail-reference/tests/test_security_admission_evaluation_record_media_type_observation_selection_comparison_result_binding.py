...
from tests.test_security_admission_candidate_media_type_observation_selection_comparison_result_binding import (
    create_binding as create_governed_binding,
)
from tests.test_security_admission_evaluation_record_media_type_comparison_result_binding import (
...
def create_binding(
    ...
    recorded = create_recorded_binding(
        media_type_comparison_result_binding=(
            governed.media_type_comparison_result_binding
        ),
    )
    return (
        SecurityAdmissionEvaluationRecordMediaTypeObservationSelectionComparisonResultBinding(
...
def test_fields_are_exact() -> None:
    ...
    assert (
        ...
        is SecurityAdmissionCandidateMediaTypeObservationSelectionComparisonResultBinding
    )
    assert (
...
def test_binding_is_immutable_and_slotted() -> None:
    ...
    with pytest.raises(FrozenInstanceError):
        binding.evaluation_record_media_type_comparison_result_binding = (  # type: ignore[misc]
            create_recorded_binding()
        )
...
def test_complete_selection_and_evaluation_lineage_remains_reachable() -> None:
    ...
    assert (
        ...
        == governed.media_type_comparison_result_binding.evaluation_basis
    )
...
def test_different_candidate_result_binding_is_rejected() -> None:
    ...
    changed_result = replace(
        candidate_result_binding.media_type_comparison_result,
        result_version=(
            candidate_result_binding
