...
from tests.test_security_admission_candidate_media_type_observation_resolution_basis import (
    create_basis,
)
...
def create_result(
    ...
    return SecurityAdmissionCandidateMediaTypeObservationSelectionResult(
...
def test_fields_are_exact() -> None:
    ...
    assert (
        ...
        is SecurityAdmissionCandidateMediaTypeObservationResolutionBasis
    )
    assert (
        result_fields[3].type
        is SecurityAdmissionCandidateDetectedMediaTypeObservation
    )
