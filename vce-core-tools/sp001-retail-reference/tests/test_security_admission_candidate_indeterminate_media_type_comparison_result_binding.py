...
def candidate_from_result(
    result: SecurityAdmissionCandidateIndeterminateMediaTypeComparisonResult,
):
    return (
        result
        .comparison_basis
...
def test_binding_fields_are_exact() -> None:
    ...
    assert (
        ...
        is SecurityAdmissionCandidateIndeterminateMediaTypeComparisonResult
    )
...
def test_evaluation_basis_requires_exact_type(invalid_value) -> None:
    with pytest.raises(
        ...
        SecurityAdmissionCandidateIndeterminateMediaTypeComparisonResultBinding(
            ...
            indeterminate_media_type_comparison_result=create_result(),
        )
...
def test_indeterminate_result_requires_exact_type(invalid_value) -> None:
    with pytest.raises(
        ...
        SecurityAdmissionCandidateIndeterminateMediaTypeComparisonResultBinding(
            ...
            indeterminate_media_type_comparison_result=invalid_value,
        )
...
def test_exact_indeterminate_result_reference_is_preserved() -> None:
    ...
    assert binding.indeterminate_media_type_comparison_result is result
    ...
    reconstructed = (
        SecurityAdmissionCandidateIndeterminateMediaTypeComparisonResultBinding(
            ...
            indeterminate_media_type_comparison_result=replace(
                binding.indeterminate_media_type_comparison_result
            ),
        )
    )
...
@pytest.mark.parametrize(
    "reason",
    tuple(SecurityAdmissionMediaTypeComparisonIndeterminacyReason),
)
def test_indeterminacy_reason_is_preserved_without_interpretation(
    ...
    assert (
        binding.indeterminate_media_type_comparison_result.reason
        is reason
    )
...
def test_determined_at_is_preserved_without_replacement() -> None:
    ...
    assert (
        binding.indeterminate_media_type_comparison_result.determined_at
