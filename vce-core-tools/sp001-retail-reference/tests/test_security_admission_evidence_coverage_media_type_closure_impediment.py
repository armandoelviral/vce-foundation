...
def create_coverage_identity(
    conflict: SecurityAdmissionCandidateMediaTypeObservationResolutionConflictResult,
    *,
...
def create_impediment(
    ...
    return SecurityAdmissionEvidenceCoverageMediaTypeClosureImpediment(
...
def test_fields_are_exact() -> None:
    ...
    assert (
        ...
        is SecurityAdmissionCandidateMediaTypeObservationResolutionConflictResult
    )
