...
class RetailProductMarginAmountIndeterminacyReason(StrEnum):
    """Closed reasons why one declared basis produced no margin amount."""
...
class RetailProductIndeterminateMarginAmountResult:
    """Typed absence of a margin amount for one calculation basis."""
