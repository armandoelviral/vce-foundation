...
MAXIMUM_RETRIEVAL_EVIDENCE_STORAGE_LOGICAL_NAME_LENGTH = 128


@dataclass(frozen=True, slots=True)
class KnowledgeGovernedRetrievalEvidenceStorageLocation:
    """Safe deterministic evidence path without filesystem mutation."""
    ...
    def artifact_path(self) -> Path:
        """Resolve the fixed evidence filename without touching storage."""
