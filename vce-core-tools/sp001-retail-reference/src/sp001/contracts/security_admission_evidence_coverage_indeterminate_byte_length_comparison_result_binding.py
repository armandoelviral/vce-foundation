...
class SecurityAdmissionEvidenceCoverageIndeterminateByteLengthComparisonResultBinding:
    """Bind indeterminate recorded byte-length evidence to one coverage identity."""
