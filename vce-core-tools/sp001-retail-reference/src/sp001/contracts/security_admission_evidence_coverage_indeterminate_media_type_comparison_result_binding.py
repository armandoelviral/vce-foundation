...
class SecurityAdmissionEvidenceCoverageIndeterminateMediaTypeComparisonResultBinding:
    """Bind indeterminate recorded media-type evidence to one coverage identity."""
